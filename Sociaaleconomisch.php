  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <!-- Title -->
        <h1 class="mt-4">sociaaleconomisch</h1>
        ...
        <!-- Preview Image -->
        <img class="img-fluid rounded" src="https://www.neimed.nl/sites/neimed.nl/themes/neimed/images/logo.png" alt="">
        ...
        <!-- Comments Form -->
        <div class="card my-4">
          <h5 class="card-header">Laat een reactie achter:</h5>
          <div class="card-body">
            <form>
