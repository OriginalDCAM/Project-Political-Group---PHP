        ...
        <div class="container">
          <div class="row">
            <div class="col-md-9 col-lg-8 mx-auto">
              <h3 class="login-heading mb-4">Wachtwoord wijzigen</h3>
              <?php echo '<form action="includes/dashboard-users.inc.php?mail=' . $mail . '&manier=changepass "method="post">
                ...
                <div class="form-label-group">
                <input type="password" id="inputRepeatPassword" class="form-control" placeholder="Herhaal wachtwoord" name="passwordRegRep" required>
                <label for="inputRepeatPassword">Herhaal nieuw wachtwoord</label>
              </div>
                <div class="custom-control custom-checkbox mb-3">
                <button class="btn btn-lg btn btn-success btn-block btn-login text-uppercase font-weight-bold mb-2" type="submit" name="versturen">Versturen</button>
              </form>'?>
            </div>
          </div>
        </div>
